(function () {
  ...
  if (remaining) {
    ...
    warn.style.cssText = 'position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:#0b0b0bcc;color:#fff;font-family:Inter,sans-serif;z-index:99999;text-align:center;padding:24px;';
